...
'org-re-reveal)~ (you might have to install =org-re-reveal= beforehand). Then
...
#+begin_src bash
emacs end-of-enterprise-linux.org -Q --batch -l export-init.el -f org-re-reveal-export-to-html --kill
#+end_src
